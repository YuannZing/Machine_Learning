...
def split_data(features, labels, test_size=0.2):
    ...
    random.shuffle(data)  # Mengacak data
    features, labels = zip(*data)  # Memisahkan kembali features dan labels
    
    # Menentukan indeks pembagian data
...
def on_predict_click():
    try:
        ...
        predicted_class = knn_classify(train_features, train_labels, test_point, k=5)
